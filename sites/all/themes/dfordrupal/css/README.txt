...
To use these stylesheets, rename the files and dfordrupal with the name of your theme.
...
dfordrupal-alpha-default-narrow.css  
...
dfordrupal-alpha-default-normal.css
...
dfordrupal-alpha-default-wide.css
